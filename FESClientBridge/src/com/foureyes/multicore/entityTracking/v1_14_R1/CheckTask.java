...
/**
 * An BukkitRunnable class that use to check all entities in
 * each world before tracking.
 */
public class CheckTask extends BukkitRunnable {
	...
	/**
	 * A method that will check all its entities and
	 * preparing for tracking them.
	 * 
