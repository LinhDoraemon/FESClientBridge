...
/**
 *  A BukkitRunnable class that will control all tasks and methods
 *  of EntityTick - which is done every second by Minecraft, and 
 *  it's one of the most serious reasons causing lag.
 *  Controlling the EntityTick is the key of EntityTracking because
 *  we only track the entity has high tick and far from player in
 *  a specific distance.
 */
public class EntityTickManager extends BukkitRunnable {
    ...
    /**
     * Disable ticking entity with specific id in a
     * world.
     * 
    ...
    /**
     * Enable ticking entity with specific id in a
     * world.
     * 
